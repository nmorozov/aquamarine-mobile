    ...
    return (
      <Container>
        <Header>
          ...
          <Body>
            <Title style={commonStyles.headerTitle}>{this.state.isDrawerOpen ? "Меню" : "Связь с УК"}</Title>
          </Body>
          <Right>
            <Button
              transparent
        ...
        >
          ...
          >
            <Topics />
            <Button style={styles.button} bordered rounded full primary onPress={() => this.goTo("ChatForm")} underlayColor="white">
              <Text style={styles.buttonText}>НАПИСАТЬ В УК</Text>
            </Button>
          </Content>
        </Drawer>
