...
//         this.seekTo(0);
    ...
    */
    ...
    _toggleFullscreen() {
        ...
        this.props.onScreenSizeChanged(state.isFullscreen);
    ...
    */
    ...
    renderTopControls() {
        ...
        return(
            <Animated.View style={[
                ...
                <ImageBackground
                    source={ require( '../../../assets/videoPlayer/top-vignette.png' ) }
    ...
    renderBack() {
        ...
        return this.renderControl(
            <Image
                source={ require( '../../../assets/videoPlayer/back.png' ) }
    ...
    renderVolume() {
        ...
        return (
            <View style={ styles.volume.container }>
                ...
                >
                    <Image style={ styles.volume.icon } source={ require( '../../../assets/videoPlayer/volume.png' ) } />
                </View>
            </View>
        );
    }
    ...
    renderFullscreen() {
        ...
        let source = this.state.isFullscreen === true ? require( '../../../assets/videoPlayer/shrink.png' ) : require( '../../../assets/videoPlayer/expand.png' );
        return this.renderControl(
            <Image source={ source } />,
            this.methods.toggleFullscreen,
    ...
    renderPlayPause() {
        ...
        let source = this.state.paused === true ? require( '../../../assets/videoPlayer/play.png' ) : require( '../../../assets/videoPlayer/pause.png' );
        return this.renderControl(
            <Image source={ source } />,
        ...
        if ( this.state.loading ) {
            return (
                <View style={ styles.loader.container }>
                    <Animated.Image source={ require( '../../../assets/videoPlayer/loader-icon.png' ) } style={[
                        styles.loader.icon,
                        { transform: [
        ...
        if ( this.state.error ) {
            return (
                <View style={ styles.error.container }>
                    <Image source={ require( '../../../assets/videoPlayer/error-icon.png' ) } style={ styles.error.icon } />
